...
const Dashboard = props => (
  <div>
    <header className="header">
      ...
      <a className="open-menu" href="#">
        <span className="label">Menu</span>
        <img className="svg" src="../static/img/icon/menu.svg" alt="menu" />
      </a>
    </header>
    ...
    <nav className="menu">
      <header>
        ...
        <h6>Menu</h6>
        <a className="x" href="#">
          <img className="svg" src="../static/img/icon/x.svg" alt="close" />
        </a>
      </header>
      <div className="nav">
        <ul className="nav-links">
          <li>
            <a className="current" href="./dashboard.html">
              Dashboard
            </a>
          </li>
        </ul>
        ...
        <ul className="nav-links">
          <li>
            <a href="./room-detail1.html">Living Room</a>
          </li>
          <li>
            <a href="./room-detail2.html">Master Bedroom</a>
          </li>
          <li>
            <a href="./room-detail3.html">Kids Room</a>
          </li>
        </ul>
        <h6>Setup</h6>
        <ul className="nav-links">
          <li>
            <a href="./rooms.html">Whare & Rooms</a>
          </li>
          <li>
            <a href="./whanau.html">Whānau</a>
          </li>
        </ul>
        <h6>Account</h6>
        <ul className="nav-links">
      ...
      <footer>
        <select className="lang-picker">
          <option
            value="English"
            data-iconurl="/img/icon/lang-eng.svg"
            selected
          >
            English
          </option>
          <option value="Te Reo Māori" data-iconurl="/img/icon/lang-mri.svg">
            Te Reo Māori
          </option>
          <option value="Samoan" data-iconurl="/img/icon/lang-smo.svg">
            Samoan
          </option>
        </select>
      </footer>
    ...
    <div className="content">
      <div className="center">
        ...
        <button style={styles.button} className="js-push-btn">
        ...
        <div className="summary-grid">
          <section className="card summary">
            ...
            <footer className="grade-high">
              ...
              <a className="btn" href="room-detail1.html">
                <img
                  className="svg"
                  src="../static/img/icon/btn-analyse.svg"
                  alt="icon"
                />Analyse
              </a>
            </footer>
          ...
          <section className="card summary">
            ...
            <footer className="grade-mid">
              ...
              <a className="btn" href="room-detail2.html">
                <img
                  className="svg"
                  src="../static/img/icon/btn-analyse.svg"
                  alt="icon"
          ...
          <section className="card summary">
            ...
            <footer className="grade-low">
              ...
              <a className="btn" href="room-detail3.html">
                <img
                  className="svg"
                  src="../static/img/icon/btn-analyse.svg"
                  alt="icon"
